...
const _sfc_main = {
  ...
  methods: {
    ...
    getDetail(id) {
      ...
      db.collection(dbCollectionName).doc(id).field("name,avater,age").get().then((res) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    k: common_vendor.sr("form", "afee028c-0"),
    l: common_vendor.p({
      model: $data.formData,
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/food_category/edit.js.map
